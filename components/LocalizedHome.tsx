...
const PROJECTS = [
  ...
  },
  {
    ...
    links: [
      { key: "github", href: "https://github.com/BenTheurich/MultivariateTimeSeriesAnnotator" },
    ],
  },
  {
    key: "securiKey",
    ...
    links: [
      ...
      {
        key: "demo",
        href: "https://github.com/BenTheurich/SecuriKeyGUI?tab=readme-ov-file#class-presentation-demo",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      {
        key: "demo",
        href: "https://github.com/BenTheurich/VideoPlayer?tab=readme-ov-file#screenshots-and-demo",
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        key: "demo",
        href: "https://drive.google.com/file/d/1f-Nvek4yxz_EDnvyU3LeZlxIyDfSh_NV/view",
      },
    ],
  },
];
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="grid gap-6 md:grid-cols-[1fr,auto] items-center">
            ...
            <div className="md:order-1">
              <p className="mb-4 text-sm uppercase tracking-widest text-graycool">
                <RetypeText>{t("hero.location")}</RetypeText>
              </p>
              <h1
                className="font-extrabold leading-tight text-balance text-gray-900 dark:text-white"
                style={{ fontSize: "clamp(2.25rem, 6vw, 4.5rem)" }}
              >
                <RetypeText>{t("hero.title")}</RetypeText>{" "}
                <span className="text-navy dark:text-accent">
                  <RetypeText>{t("hero.nameAccent")}</RetypeText>
                </span>
                {" — "}
                <RetypeText>{t("hero.subtitle")}</RetypeText>
              </h1>
              <p className="mt-4 max-w-2xl text-lg text-gray-700 dark:text-gray-300">
                <RetypeText>{t("hero.description")}</RetypeText>
              </p>
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  href="/Ben-Theurich-CV.pdf"
                  download
                  className="rounded-full bg-navy px-5 py-2.5 text-white dark:bg-white dark:text-black"
                >
                  <RetypeText>{t("hero.downloadCV")}</RetypeText>
                </a>
                <a
                  href="https://www.linkedin.com/in/ben-theurich/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="rounded-full bg-accent/10 px-5 py-2.5 text-accent hover:bg-accent/20"
                >
                  <RetypeText>{t("hero.linkedin")}</RetypeText>
                </a>
                <a
                  href="https://github.com/BenTheurich"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="rounded-full bg-accent/10 px-5 py-2.5 text-accent hover:bg-accent/20"
                >
                  <RetypeText>{t("hero.github")}</RetypeText>
                </a>
                <a
                  href="#projects"
                  className="rounded-full bg-accent/10 px-5 py-2.5 text-accent hover:bg-accent/20"
                >
                  <RetypeText>{t("hero.viewProjects")}</RetypeText>
                </a>
              </div>
            </div>
          </div>
      ...
      <section id="about" data-section aria-labelledby="about-title">
        <div className="mx-auto max-w-6xl px-4">
          <h2 id="about-title" className="text-3xl md:text-4xl font-bold tracking-tight">
            <RetypeText>{t("about.title")}</RetypeText>
          </h2>
          <div className="mt-6 prose max-w-none dark:prose-invert">
            <div className="prose max-w-none dark:prose-invert prose-p:my-0 space-y-4">
              <p>
                <RetypeText>{t("about.p1")}</RetypeText>
              </p>
              <p>
                <RetypeText>{t("about.p2")}</RetypeText>
              </p>
              <p>
                <RetypeText>{t("about.p3")}</RetypeText>
              </p>
              <p>
                <RetypeText>{t("about.p4")}</RetypeText>
              </p>
              <p>
                <RetypeText>{t("about.p5")}</RetypeText>
              </p>
              <p>
                <RetypeText>{t("about.p6")}</RetypeText>
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="projects" data-section aria-labelledby="projects-title">
        <div className="mx-auto max-w-6xl px-4">
          <h2 id="projects-title" className="text-3xl md:text-4xl font-bold tracking-tight">
            <RetypeText>{t("projects.title")}</RetypeText>
          </h2>
          <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {PROJECTS.map((p) => {
              ...
              return (
                <article
                  key={p.key}
                  className="card motion-card clickable-card group overflow-hidden"
                >
                  <a
                    href={primaryHref}
                  ...
                  <div className="relative aspect-[3/2] w-full overflow-hidden bg-black/5">
                    ...
                    <div className="project-tech-overlay">
                      <ul className="project-tech-list" aria-label={t("a11y.techStack")}>
                        {p.tags.map((tag) => (
                          <li key={tag} className="project-tech-pill">
                            {tag}
                          </li>
                        ))}
                      </ul>
                  ...
                  <div className="p-5">
                    ...
                    <p className="mt-2 text-sm text-gray-700 dark:text-gray-300">
                      <RetypeText>{t(`projects.cards.${p.key}.desc`)}</RetypeText>
                    </p>
                    <div className="mt-4 flex flex-wrap gap-3">
                      {p.links.map((l) =>
                        l.href.startsWith("#") ? (
                          ...
                          >
                            <RetypeText>{t(`projects.cards.${p.key}.links.${l.key}`)}</RetypeText>
                          </a>
                        ) : (
                          <a
                            key={l.href + l.key}
      ...
      <section id="experience" data-section aria-labelledby="experience-title">
        <div className="mx-auto max-w-6xl px-4">
          <h2 id="experience-title" className="text-3xl md:text-4xl font-bold tracking-tight">
            <RetypeText>{t("experience.title")}</RetypeText>
          </h2>
            ...
            {EXPERIENCE_ROLES.map((role) => (
              <li key={role.key} className="mb-8 last:mb-0">
                ...
                <h3 className="text-lg font-semibold">
                  <RetypeText>{t(`experience.roles.${role.key}.title`)}</RetypeText>
                  {" — "}
                  <a
                    href={role.href}
                    target="_blank"
                  ...
                  >
                    <RetypeText>{t(`experience.roles.${role.key}.company`)}</RetypeText>
                  </a>
                </h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  <RetypeText>{t(`experience.roles.${role.key}.period`)}</RetypeText>
                  {" • "}
                  <RetypeText>{t(`experience.roles.${role.key}.location`)}</RetypeText>
                </p>
      ...
      <section id="education" data-section aria-labelledby="education-title">
        <div className="mx-auto max-w-6xl px-4">
          <h2 id="education-title" className="text-3xl md:text-4xl font-bold tracking-tight">
            <RetypeText>{t("education.title")}</RetypeText>
          </h2>
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            <div className="card motion-card clickable-card group overflow-hidden">
              ...
              <div className="h-40 w-full overflow-hidden bg-black/5">
                <img
                  src="/education/tum.jpg"
                  alt={t("education.institutions.tum.imageAlt")}
                  className="motion-card-image h-full w-full object-cover"
                  loading="lazy"
                />
              </div>
              <div className="p-5">
                <h3 className="font-semibold">
                  <RetypeText>{t("education.institutions.tum.name")}</RetypeText>
                </h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  <RetypeText>{t("education.institutions.tum.degree")}</RetypeText>
                </p>
              </div>
            </div>
            ...
            <div className="card motion-card clickable-card group overflow-hidden">
              ...
              <div className="h-40 w-full overflow-hidden bg-black/5">
                <img
                  ...
                  alt={t("education.institutions.csusm.imageAlt")}
                  className="motion-card-image h-full w-full object-cover"
                  loading="lazy"
                />
              </div>
              <div className="p-5">
                <h3 className="font-semibold">
                  <RetypeText>{t("education.institutions.csusm.name")}</RetypeText>
                </h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  <RetypeText>{t("education.institutions.csusm.degree")}</RetypeText>
                </p>
              </div>
            </div>
          </div>
